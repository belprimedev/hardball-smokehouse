        ...
        <SidebarMenuItem>
            <DropdownMenu>
                <DropdownMenuTrigger as-child>
                    <SidebarMenuButton size="lg" class="data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground hover:bg-gray-100 dark:hover:bg-gray-800 relative">
                        <Bell class="text-gray-700 dark:text-gray-300" />
                ...
                <DropdownMenuContent 
                    class="w-80 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 max-h-96 overflow-y-auto" 
                    align="start" 
                    side="right"
                    :side-offset="8"
                >
                    ...
                    <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div v-if="unreadCount > 0" class="bg-red-500 text-white text-xs px-2 py-1 rounded-full">
                            {{ unreadCount }} new
                        </div>
                    </div>
                    ...
                    <div class="p-2">
                        ...
                        <div v-else class="space-y-2">
                            <div
                                ...
                                class="p-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer rounded-lg"
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div v-if="notification.type === 'reservation' && notification.data"
                                             class="mt-2 p-2 bg-gray-50 dark:bg-gray-700 rounded text-xs">
