            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul
                        ...
                        <li>
                            <a :href="route('home')"
                                class="block py-2 px-3 text-white text-xl font-black rubik bg-green-700 rounded md:bg-transparent md:text-green-700 md:p-0 md:dark:text-green-500"
                                aria-current="page">Menu</a>
                        </li>
                        <li>
                            <a :href="route('home')"
                                class="block py-2 px-3 text-gray-300 text-xl font-black rubik rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-green-700 md:p-0 md:dark:hover:text-green-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                                Cocktail</a>
                        </li>
                        <li>
                            <a :href="route('home')"
