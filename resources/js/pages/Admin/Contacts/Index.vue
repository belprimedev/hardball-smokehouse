                        ...
                        <div class="px-6 py-4 border-b border-gray-200 dark:border-neutral-700">
                            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
                                ...
                                <div class="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                    <div>
                                        <p class="text-sm font-medium text-blue-600 dark:text-blue-400">New</p>
                                ...
                                <div class="flex items-center justify-between p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                                    <div>
                                        <p class="text-sm font-medium text-yellow-600 dark:text-yellow-400">Read</p>
                                        <p class="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{{ stats.read }}</p>
                                    </div>
                                    <Eye class="h-8 w-8 text-yellow-500" />
                                </div>

                                <div class="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                    <div>
                                        <p class="text-sm font-medium text-green-600 dark:text-green-400">Replied</p>
                                        <p class="text-2xl font-bold text-green-600 dark:text-green-400">{{ stats.replied }}</p>
                                    </div>
