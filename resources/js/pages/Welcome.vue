                    ...
                    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
                        ...
                        <div class="mt-5 max-w-2xl text-center mx-auto">
                            <h1
                                ...
                                Hardball Smokehouse
                                <span
                                    class="bg-clip-text bg-linear-to-tl from-blue-600 to-violet-600 text-transparent">Together</span>
                            </h1>
                        </div>
                        <!-- End Title -->
                        ...
                        <div class="mt-8 gap-3 flex justify-center">
                            ...
                            <button type="button"
                                ...
                                <span
                                    ...
                                    <svg class="shrink-0 size-4 group-hover:rotate-6 transition"
                        ...
                        <div class="mt-5 flex flex-col sm:flex-row justify-center items-center gap-1.5 sm:gap-3">
                            ...
                            <svg class="hidden sm:block size-5 text-gray-300 dark:text-neutral-600" width="16"
